        ...
        while ($donnees3 = $reponse3->fetch())
                {  
                    ...
                    <tr>
                        ...
                        <td><?php echo number_format($donnees3['PrixAuj'], 13 , "," , " ") . " €";?></td>
                        <td><?php echo number_format($donnees3['PrixHier'], 6 , "," , " ") . " €";?></td>
                        <td><?php echo number_format($donnees3['PrixDebut'], 6 , "," , " ") . " €";?></td>
                        <td><?php echo number_format($evolution * 100, 0, "," , " ") . " %";?></td>
                        <td><?php echo number_format($donnees3['Maxi'], 6 , "," , " ") . " €";?></td>
                        <td><?php echo number_format($donnees3['Mini'], 6 , "," , " ") . " €";?></td>
                        <td><?php echo number_format($donnees3['FibVente'], 6 , "," , " ") . " €";?></td>
                        <td><?php echo number_format($donnees3['FibAchat'], 6 , "," , " ") . " €";?></td>
                    </tr>
                    <?php
                }
...
{
echo '<div id="pages"><a href="vue_densemble.php?page='.$i.'">'.$i.'</a></div> ';
}
}
echo '</p>';
?>              
