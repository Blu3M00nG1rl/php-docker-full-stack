	...
	while ($donnees2 = $reponse2->fetch())
				{
					...
					$evolution = @(($donnees2['PrixAuj']-$donnees2['PrixUnAn'])/$donnees2['PrixUnAn']);
						...
						if
						($evolution_24_heures > 0 AND $donnees2['PrixAuj'] < $donnees2['FibAchat'] AND $evolution*100 > 0)
						{
?>
						<tbody>
							<tr>
								...
								<td><?php echo number_format($donnees2['PrixAuj'], 10 , "," , " ") . " E";?></td>
								<td><?php echo number_format($donnees2['PrixHier'], 10 , "," , " ") . " E";?></td>
								<td><?php echo number_format($evolution * 100, 0, "," , " ") . " %";?></td>
								<td><?php echo number_format($donnees2['market_cap'], 0 , "," , " ") . " E";?></td>
								<td><?php echo number_format($donnees2['volume'], 0 , "," , " ") . " E";?></td>
							</tr>
<?php
						}
				}
