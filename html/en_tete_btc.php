...
?>
		<header>
			<div id="bloc1">
				<div id="MAJ">
					<form action="Import_BTC.php" method="POST">
			...
			<nav id="nav_principale">
				<a href="index_btc.php">Portefeuille</a>
				<a href="Export_btc.php">Export</a>
      			<a href="Vente_btc.php">Vente</a>
    			<a href="Achat_btc.php">Achat</a>
      			<a href="vue_densemble_btc.php">Synthèse</a>  			
			</nav>
		</header>
<?php
$reponse->closecursor();
