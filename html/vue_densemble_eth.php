...
<?php
    ...
    $reponse3 = $bdd->query('SELECT coins_list.id as Coin, coins_list.symbol, coins_list.name, coins_list.Portefeuille, 
        ...
        while ($donnees3 = $reponse3->fetch())
                ...
                if ($donnees3['JourneeDebut'] > $donnees3['JourneeUnAn'])
                {
                    $donnees3['PrixUnAn'] = $donnees3['PrixDebut'];
                    $evolution = (($donnees3['PrixAuj']-$donnees3['PrixDebut'])/$donnees3['PrixDebut']);
                }
                    else
                {
                    $evolution = (($donnees3['PrixAuj']-$donnees3['PrixUnAn'])/$donnees3['PrixUnAn']);
                }
?>
<?php //echo $donnees2['id'] . $donnees2['JourneeDebut'];?>
                <tbody>
                    <tr>
                        ...
                        <td><?php echo number_format($donnees3['PrixAuj'], 6 , "," , " ") . " E";?></td>
                        <td><?php echo number_format($donnees3['PrixHier'], 6 , "," , " ") . " E";?></td>
                        <td><?php echo number_format($donnees3['PrixUnAn'], 6 , "," , " ") . " E";?></td>
                        <td><?php echo number_format($evolution * 100, 0, "," , " ") . " %";?></td>
                        <td><?php echo number_format($donnees3['Maxi'], 6 , "," , " ") . " E";?></td>
                        <td><?php echo number_format($donnees3['Mini'], 6 , "," , " ") . " E";?></td>
                        <td><?php echo number_format($donnees3['FibVente'], 6 , "," , " ") . " E";?></td>
                        <td><?php echo number_format($donnees3['FibAchat'], 6 , "," , " ") . " E";?></td>
                    </tr>
<?php
                }
...
for($i=1; $i<=$nombreDePages; $i++) //On fait notre boucle
{
     ...
     {
          echo '<div id="pages"><a href="vue_densemble_eth.php?page='.$i.'">'.$i.'</a></div> ';
     }
}
echo '</p>';
?>
